package techproed.BURAKHOCA.day21_Excel;
...
public class C03_JSExecutor_Click extends TestBase {
    ...
    /*
    Eger bir web sayfasının HTML kodları tamamen yada kısmen
    JavaScript kullanılarak olusturulduysa,
    o sayfayla etkilesimde bulunmak icin standart WebDriver
     komutları yetersiz kalabilir.


    Bu durumda sayfayla etkilesime gecebilmek icin
    JavaScriptExecuter arayuzunu kullanmak gerekir.
    JavaScriptExecuter arayuzu sayfaya dogrudan erisebilir.

    Ancak, mümkünse WebDriver'ın sundugu standart yöntemlerle
    sayfayla etkilesime gecmek her zaman daha iyidir.
 ...
 */
    ...
    public void jsExecuterClick() {
        ...
        click(returns); // TestBase de method yazdık kullandık.
