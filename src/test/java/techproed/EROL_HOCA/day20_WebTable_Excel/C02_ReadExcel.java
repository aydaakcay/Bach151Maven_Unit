...
public class C02_ReadExcel {
          ...
          /*
        EXCEL dosyasından veri okuyabilmemiz için öncelikle pom.xml dosyamıza
         poi ve poi.ooxml dependency'lerini
         yüklememiz gerekir.
        Sonra üzerinde çalışacağımız excel dosyasını projemizde
        src>test>java>techpoed>resources package'i içine
         koyarız.
     */
    ...
    public void test01() throws IOException {
        ...
        Workbook workbook = WorkbookFactory.create(fis); // --> Akışa aldığımız sayfayı okuyoruz
    ...
    public void test02() throws IOException {
        ...
        System.out.println("1. Satır 1. Sutun bilgisi :" + birinciSatirBirinciSutun);
    ...
    public void test03() throws IOException {
        ...
        //NOT:getPhysicalNumberOfRows() methodu kullanılan yani içi dolu olan satırların
        // sayısını verir.Index 1 den başlar


        //Sayfadaki satır sayısını yazdırınız
        System.out.println("Sayfada ki Satır Sayısı :" + workbook.getSheet("Sheet1").getLastRowNum());
