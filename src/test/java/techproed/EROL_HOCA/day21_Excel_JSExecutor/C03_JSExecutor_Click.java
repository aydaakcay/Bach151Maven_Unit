...
public class C03_JSExecutor_Click extends TestBase {
    ...
    // <script> tagi ile olusturdugumuz webelementleri de
    // js executor ile handle edebiliriz
    ...
    public void test03() {
       ...
       // driver.findElement(By.xpath("(//*[@class='a-button-inner'])[1]")).click();//-->uyarı kapatıldı
        ...
        //Sell linkine js executor kullanarak tıklayınız
        click(sellLinki); // Uyarıyı kapatmadan javaScript ile klikledik
                        //-->Click methodu ile normal click yapmayı denedi fakat olmadı js excutor ile click yaptı
