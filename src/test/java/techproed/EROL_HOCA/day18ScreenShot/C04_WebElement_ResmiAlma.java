...
public class C04_WebElement_ResmiAlma extends TestBase {

    /*

    /*
         Bir webelementin resmini almak için önce Webelementi locate edip bir
         webelemente assing ederiz.
        ve bu webelementi direk getScreenShotAs() methodunu kullanarak resmini belirttimi
        z dosyaya kaydederiz.
     */
     ...
     */
    @Test
    public void name() throws IOException, IOException {
