...
public class C03_KeyDownKeyUp extends TestBase {
    ...
    public void test01() {
        ...
        actions.keyDown(aramaKutusu, Keys.SHIFT).//--> Arama Kutusunda shift tuşuna bastık
                ...
                sendKeys("-java", Keys.ENTER). //--> Bu kısmı Shift' serbest bıraktıgımız için kücük yazdı
                perform();
    ...
    public void test02() {
        ...
        //arama kutusunda shift tusuna basili olarak selenium yazdiralim
        // ve shift tusunu serbest birakarak java yazdiralim
        WebElement aramaKutusu = driver.findElement(By.xpath("//*[@class='gLFyf']"));
    ...
    public void test03() {
        ...
        WebElement aramaKutusu = driver.findElement(By.xpath("//*[@class='gLFyf']"));
        aramaKutusu.sendKeys("Selenyum", Keys.ENTER);
        ...
        driver.findElement(By.xpath("//*[@class='gLFyf']")).
                sendKeys(Keys.CONTROL,"v",Keys.ENTER); //--> Kestiginiz metni ctrl+v tuşu ile
                                                                // tekrar arama kutusuna yapıştırdık ve ararttırdık
