...
public class C01_JSExecutorScroll extends TestBase {
    ...
    /*
    Actions class'ındaki gibi js executor ile de sayfada scroll işlemi
    yapabiliriz. Bir webelementi locate edip
    o webelement görünür olana kadar scroll yapabiliriz
    "arguments[0].scrollIntoView(true);",Webelement --> Bu script kodu ile belirtmiş olduğumuz
     webelemente scroll
    yaparız
 */
    ...
    public void test01() {
        ...
        bekle(2);
        tumSayfaResmi(); //--> Ekran resmi alma metodumuzu kullandık
    ...
    public void test02() {
        ...
        //--> x=0 , y = 2000 pixel olarak bir noktaya scroll yapar


    }


    // METHOD KULLANARAK YAZDIK
    @Test
    public void test03() {
        //Techpro education ana sayfasına git
        driver.get("https://techproeducation.com");
